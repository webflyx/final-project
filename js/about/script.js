...
const animation30 = document.querySelector(".page-title");
const animation31 = document.querySelector(".about-foxfit__block1");
const animation32 = document.querySelector(".about-foxfit__block2");
const animation33 = document.querySelector(".about-foxfit-banner");

if (window.screen.width <= 1024) {
  animation7.classList.add("post");
  animation8.classList.add("post");
  animation30.classList.add("post");
  animation31.classList.add("post");
  animation32.classList.add("post");
  animation33.classList.add("post");
}
